...
* TODO Install fontaine.el to be able to change font size dynamically and setup bold and italic fonts
* TODO Setup some treesitter parsers for most used languages
* TODO Cleanup this file and merge Emacs notes to this file
